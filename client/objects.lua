...
RegisterNetEvent('police:client:SpawnSpikeStrip', function()
    if #SpawnedSpikes + 1 < Config.MaxSpikes then
        if (PlayerJob.name == "police" or PlayerJob.name == "lspd" or PlayerJob.name == "bcso" or PlayerJob.name == "sasp" or PlayerJob.name == "fbi" or PlayerJob.name == "iaa") and PlayerJob.onduty then
